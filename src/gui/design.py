...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_run_belva.setGeometry(QtCore.QRect(530, 30, 101, 31))
        self.pushButton_run_belva.setObjectName(_fromUtf8("pushButton_run_belva"))
        self.progressBar = QtGui.QProgressBar(self.centralwidget)
        self.progressBar.setGeometry(QtCore.QRect(300, 200, 118, 23))
        ...
        self.frame_2.setGeometry(QtCore.QRect(10, 230, 411, 161))
        self.frame_2.setFrameShape(QtGui.QFrame.StyledPanel)
        self.frame_2.setFrameShadow(QtGui.QFrame.Raised)
        self.frame_2.setObjectName(_fromUtf8("frame_2"))
        self.textBrowser_status_msgs = QtGui.QTextBrowser(self.frame_2)
        self.textBrowser_status_msgs.setGeometry(QtCore.QRect(10, 10, 391, 91))
        ...
        self.textBrowser_status_msgs_brief.setGeometry(QtCore.QRect(10, 110, 391, 41))
        self.textBrowser_status_msgs_brief.setObjectName(_fromUtf8("textBrowser_status_msgs_brief"))
        self.label_2 = QtGui.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(10, 200, 191, 21))
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.label_3 = QtGui.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(230, 200, 64, 21))
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.frame_3 = QtGui.QFrame(self.centralwidget)
        self.frame_3.setGeometry(QtCore.QRect(10, 120, 411, 51))
        ...
        self.label_6.setGeometry(QtCore.QRect(430, 40, 91, 21))
        self.label_6.setObjectName(_fromUtf8("label_6"))
        self.label_7 = QtGui.QLabel(self.centralwidget)
        self.label_7.setGeometry(QtCore.QRect(640, 10, 171, 21))
        self.label_7.setObjectName(_fromUtf8("label_7"))
        self.frame_7 = QtGui.QFrame(self.centralwidget)
        self.frame_7.setGeometry(QtCore.QRect(640, 30, 181, 361))
        ...
        self.listWidget_policies_mutate.setGeometry(QtCore.QRect(10, 10, 161, 161))
        ...
        self.listWidget_policies_select.setGeometry(QtCore.QRect(10, 180, 161, 171))

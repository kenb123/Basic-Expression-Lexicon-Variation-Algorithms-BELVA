...
#--------------------------------------------------------------------------
    ...
    number_txt = sum( ".txt" in x for x in filename_dict.values())
    number_raw = sum( ".raw" in x for x in filename_dict.values())

    total_files = len(filename_dict)
...
######    global_gui_progressBar --> j
    ...
    i = 0
    count = 0
    for full_path in filename_dict:
        if filename_dict[full_path] == ".xml":
            i += 1
    ...
    i = 0
    for full_path in filename_dict:
        if filename_dict[full_path] == ".txt":
            i += 1
    ...
    i = 0
    for full_path in filename_dict:
        if filename_dict[full_path] == ".raw":
            i += 1
...
#--------------------------------------------------------------------------
    ...
    for line in f:
        if str(line).strip():
            ...
            for common_word in remove_common_words:
                if str(line).strip() == common_word:
                    is_common_word = True
